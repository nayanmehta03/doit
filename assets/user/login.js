...
const togglePasswordSign = document.getElementById("si-pass-show");
const itagsi = document.querySelector(".input-field i#togglePasswordSign");
const su_pass_si_inp = document.getElementById("si-pass");
togglePasswordSign.addEventListener("click", () => {console.log("HELlo")
  if (itagsi.classList.contains("fa-eye")) {
    itagsi.classList.remove("fa-eye");
    itagsi.classList.add("fa-eye-slash");
  } else {
    itagsi.classList.remove("fa-eye-slash");
    itagsi.classList.add("fa-eye");
  }
  const typesi =
    su_pass_si_inp.getAttribute("type") === "password" ? "text" : "password";
  su_pass_si_inp.setAttribute("type", typesi);
  togglePasswordSign.innerHTML = "";
  togglePasswordSign.appendChild(itagsi);
});
...
document.getElementById("sign-up-btn").addEventListener("click", () => {
    if (
        ...
        document.getElementById("error-msg-signup").innerHTML =
            "<i class='fa fa-times-circle'></i> Please enter your Full Name.";
        ...
        document.getElementById("error-msg-signup").style.display = "block";
    } else if (document.getElementById("su-pass-parent").classList.contains("weak") |
        (su_pass.value == "")
    ) {
        document.getElementById("error-msg-signup").innerHTML =
